...
beforeEach(() => { onStatusChange.mockClear(); onDelete.mockClear(); });

describe('BookingsTable', () => {
  it('renders empty state when no bookings', () => {
    render(<BookingsTable bookings={[]} onStatusChange={onStatusChange} onDelete={onDelete} />);
    expect(screen.getByText(/no bookings found/i)).toBeInTheDocument();
  });

  it('renders all bookings', () => {
    render(<BookingsTable bookings={BOOKINGS} onStatusChange={onStatusChange} onDelete={onDelete} />);
